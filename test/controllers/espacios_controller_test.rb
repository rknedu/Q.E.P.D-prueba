...
class EspaciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create espacio" do
    assert_difference('Espacio.count') do
      post espacios_url, params: { espacio: { Anfora: @espacio.Anfora, reduccion: @espacio.reduccion, urna_adulto: @espacio.urna_adulto, urna_parvulo: @espacio.urna_parvulo } }
    end
  ...
  test "should update espacio" do
    patch espacio_url(@espacio), params: { espacio: { Anfora: @espacio.Anfora, reduccion: @espacio.reduccion, urna_adulto: @espacio.urna_adulto, urna_parvulo: @espacio.urna_parvulo } }
