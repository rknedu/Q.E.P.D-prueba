...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { calle: @direction.calle, comuna_id: @direction.comuna_id, empresa_id: @direction.empresa_id, numero: @direction.numero, sector: @direction.sector } }
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { calle: @direction.calle, comuna_id: @direction.comuna_id, empresa_id: @direction.empresa_id, numero: @direction.numero, sector: @direction.sector } }
