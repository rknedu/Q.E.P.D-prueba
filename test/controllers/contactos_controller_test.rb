...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { direccion: @contacto.direccion, email: @contacto.email, fono: @contacto.fono, nombre: @contacto.nombre, nombre_de_contacto: @contacto.nombre_de_contacto } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { direccion: @contacto.direccion, email: @contacto.email, fono: @contacto.fono, nombre: @contacto.nombre, nombre_de_contacto: @contacto.nombre_de_contacto } }
