...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { cobro_mantencion: @support.cobro_mantencion, tiempo_cobro: @support.tiempo_cobro } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { cobro_mantencion: @support.cobro_mantencion, tiempo_cobro: @support.tiempo_cobro } }
