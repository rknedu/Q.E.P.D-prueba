...
class ComponentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create componente" do
    assert_difference('Componente.count') do
      post componentes_url, params: { componente: { nombre: @componente.nombre, servicio_id: @componente.servicio_id } }
    end
  ...
  test "should update componente" do
    patch componente_url(@componente), params: { componente: { nombre: @componente.nombre, servicio_id: @componente.servicio_id } }
